...
df4jsn.write.insertInto('db_d170_bbe_core_iws.cl_tmagic_l0_fiberOnLocation_mt', overwrite=True)

# test , just for demonstration, read and show data from target table
df_FoL_demo0 = spark.table('db_d170_bbe_core_iws.cl_tmagic_l0_fiberOnLocation_mt')
df_FoL_demo0.show()
