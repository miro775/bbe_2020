...
class SOEToClProcess(IProcess):
    ...
    def __init__(self, save_dfs_if_exc=False, persist_result_dfs=False):
        ...
        self._tmagic_messagetype = 'DigiOSS - ServiceOrderEvent'
        self._tmagic_messagetype_SOSI= 'SOSI - ServiceOrderEvents'
    ...
    def logic(self, in_dfs):
        ...
        df_al = df_input.filter( ((df_input['messagetype'] == self._tmagic_messagetype) \
                                | (df_input['messagetype'] == self._tmagic_messagetype_SOSI)) \
