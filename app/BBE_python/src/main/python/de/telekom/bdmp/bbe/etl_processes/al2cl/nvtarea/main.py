...
from de.telekom.bdmp.bbe.etl_processes.al2cl.nvtarea.process import NvtareaToClProcess


class NvtToClProcessNode(IProcessNode):
    pass


if __name__ == '__main__':
    tmagic_to_cl_process = NvtareaToClProcess()
    ...
    tmagic_process_node = NvtToClProcessNode(tmagic_to_cl_process)
