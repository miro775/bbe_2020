...
class PsoItemToClProcess(IProcess):
    ...
    def logic(self, in_dfs):
        ...
        df_al_json = df_al.withColumn('json_data', F.from_json(F.col('orderitems_struct'), json_schema_full.schema)) \
            ...
            F.expr("json_data.id").alias('orderitems_id'),
            F.expr("json_data.productMaterialId").alias('orderitems_productMaterialId'),
            F.expr("json_data.name").alias('orderitems_name'),
            F.expr("json_data.itemType").alias('orderitems_itemType'),
